...
computed by `cohbandtest` and stored in the `bandp` slot. Phases of $\Pi_\sigma^{(12)}$
...
implements Fourier surrgates only, and only applies for `norm` equal to `none`, `powall`, 
