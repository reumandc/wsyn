...
magnitude of the mean, $\Pi_\sigma^{(12)}$, of the quantity 
$w_{1,n,\sigma}(t)\overline{w_{2,n,\sigma}(t)}$ over all
time-location pairs for which the quantity is still defined after wavelet scalloping
is performed. The overline is complex conjugation. This quantity is a function of timescale. 
Here the $w_{1,n,\sigma}(t)$ are wavelet transforms normalized in one of 
...
that case the coherence is further increased if
there are correlations in the amplitudes of the fluctuations.

<!-- Now demo it using the pedagog fig example-->
